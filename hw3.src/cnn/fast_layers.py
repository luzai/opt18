...
import numpy as np
try:
    from cnn.im2col_cython import col2im_cython, im2col_cython
    from cnn.im2col_cython import col2im_6d_cython
    use_cython=True
except ImportError:
    print('run the following from the cnn directory and try again:')
    print('python setup.py build_ext --inplace')
    use_cython =False

from cnn.im2col import *
